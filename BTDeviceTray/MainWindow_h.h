...
#ifndef ____x_BTDeviceTray_CIMainWindow_FWD_DEFINED__
#define ____x_BTDeviceTray_CIMainWindow_FWD_DEFINED__

namespace BTDeviceTray {
    interface IMainWindow;
} /* BTDeviceTray */
#define __x_BTDeviceTray_CIMainWindow BTDeviceTray::IMainWindow

#endif // ____x_BTDeviceTray_CIMainWindow_FWD_DEFINED__
...
/*
 *
 * Interface BTDeviceTray.IMainWindow
 *
 * Interface is a part of the implementation of type BTDeviceTray.MainWindow
 *
 *
 * The IID for this interface was automatically generated by MIDLRT.
 *
 * Interface IID generation seed: BTDeviceTray.IMainWindow:
 *
 *
 */
#if !defined(____x_BTDeviceTray_CIMainWindow_INTERFACE_DEFINED__)
#define ____x_BTDeviceTray_CIMainWindow_INTERFACE_DEFINED__
extern const __declspec(selectany) _Null_terminated_ WCHAR InterfaceName_BTDeviceTray_IMainWindow[] = L"BTDeviceTray.IMainWindow";

namespace BTDeviceTray {
    /* [uuid("8db6df38-ec48-5f07-8216-9ec80a27f6e2"), version, object, exclusiveto] */
    MIDL_INTERFACE("8db6df38-ec48-5f07-8216-9ec80a27f6e2")
...
EXTERN_C const IID IID___x_BTDeviceTray_CIMainWindow;
#endif /* !defined(____x_BTDeviceTray_CIMainWindow_INTERFACE_DEFINED__) */


/*
 *
 * Class BTDeviceTray.MainWindow
 *
 * RuntimeClass can be activated.
 *
 * Class implements the following interfaces:
 *    BTDeviceTray.IMainWindow ** Default Interface **
 *
...
#ifndef RUNTIMECLASS_BTDeviceTray_MainWindow_DEFINED
#define RUNTIMECLASS_BTDeviceTray_MainWindow_DEFINED
extern const __declspec(selectany) _Null_terminated_ WCHAR RuntimeClass_BTDeviceTray_MainWindow[] = L"BTDeviceTray.MainWindow";
#endif
...
#ifndef ____x_BTDeviceTray_CIMainWindow_FWD_DEFINED__
#define ____x_BTDeviceTray_CIMainWindow_FWD_DEFINED__
typedef interface __x_BTDeviceTray_CIMainWindow __x_BTDeviceTray_CIMainWindow;
...
extern const __declspec(selectany) _Null_terminated_ WCHAR InterfaceName_BTDeviceTray_IMainWindow[] = L"BTDeviceTray.IMainWindow";
/* [uuid("8db6df38-ec48-5f07-8216-9ec80a27f6e2"), version, object, exclusiveto] */
typedef struct __x_BTDeviceTray_CIMainWindowVtbl
{
    BEGIN_INTERFACE
    HRESULT ( STDMETHODCALLTYPE *QueryInterface)(
    __RPC__in __x_BTDeviceTray_CIMainWindow * This,
...
} __x_BTDeviceTray_CIMainWindowVtbl;

interface __x_BTDeviceTray_CIMainWindow
{
    CONST_VTBL struct __x_BTDeviceTray_CIMainWindowVtbl *lpVtbl;
};

#ifdef COBJMACROS
#define __x_BTDeviceTray_CIMainWindow_QueryInterface(This,riid,ppvObject) \
( (This)->lpVtbl->QueryInterface(This,riid,ppvObject) )

#define __x_BTDeviceTray_CIMainWindow_AddRef(This) \
        ( (This)->lpVtbl->AddRef(This) )

#define __x_BTDeviceTray_CIMainWindow_Release(This) \
        ( (This)->lpVtbl->Release(This) )

#define __x_BTDeviceTray_CIMainWindow_GetIids(This,iidCount,iids) \
        ( (This)->lpVtbl->GetIids(This,iidCount,iids) )

#define __x_BTDeviceTray_CIMainWindow_GetRuntimeClassName(This,className) \
        ( (This)->lpVtbl->GetRuntimeClassName(This,className) )

#define __x_BTDeviceTray_CIMainWindow_GetTrustLevel(This,trustLevel) \
